...
const Login_TT = () => {
  ...
  return (
    <ImageBackground source={require("@/assets/images/LogIn.png")} style={Login_TT_Style.background}>
        ...
        <KeyboardAvoidingView behavior="height" style={{flex: 1}}>
          ...
          <View style={Login_TT_Style.bottomContainer}>
            ...
            <View style={Login_TT_Style.inputContainer}>
              ...
              <View style={Login_TT_Style.forgotPassword}>
                <Text >Quên mật khẩu?</Text>
              </View>
            </View>

            {/* Nút Đăng nhập */}
            <TouchableOpacity style={Login_TT_Style.loginButton}>
